...
import zen_1 from '../../Assets/zen-1.png'
import zen_2 from '../../Assets/zen-2.png'
import zen_3 from '../../Assets/zen-3.png'
import zen_4 from '../../Assets/zen-4.png'
import zen_5 from '../../Assets/zen-5.png'
...
export default function Zenadmin() {
    ...
    return (
        <>
            <div className="portfoliomain bg-cover bg-no-repeat bg-center md:min-h-[350px] min-h-[200px] md:pt-[100px] pt-[50px] relative z-[1] after:absolute after:content-[''] after:top-0 after:z-[-1] after:left-0 after:w-full after:h-full after:bg-[#140c1cb3]" style={{ backgroundImage: `url(${background})` }}>
                <div>
                    <h1 className='sm:text-[50px] text-[30px] leading-[1.2] text-white text-center capitalize font-bold'>zen admin panel</h1>
            ...
            <div className='bg-[#050709]'>
                <div className='container mx-auto md:px-10 px-3 md:py-[100px] py-[70px]'>
                    <div className='bg-[#2A1454] px-[60px] pt-[60px]'>
                        <div>
                            <img className='w-full h-full bg-cover bg-no-repeat' src={zen} alt="" />
                        </div>
                    </div>
                    <div className='grid md:grid-cols-2 grid-cols-1 pt-[50px] gap-5'>
                        <div className=''>
                            <h2 className='text-[45px] font-bold leading-[1.2] mb-3 text-white capitalize'>Zen admin panel</h2>
                            ...
                            <button className='hire-btn text-[15px] font-bold rounded-[50px] mt-8 px-[35px] py-[17px] transition-all duration-300 '><a className='flex items-center gap-2' href="https://react-app-material-ui-git-second-yogesh-gabani.vercel.app/" target='_blank'>Live Preview<GoArrowUpRight className='text-[20px]' /></a></button>
                        </div>
                    ...
                    <div className="slider-container my-10">
                        <Slider {...settings}>
                            <div className=''>
                                <div className='mx-3 '>
                                    <img className='w-full h-full' src={zen_1} alt="" />
                                </div>
                            </div>
                            <div>
                                <div className='mx-3'>
