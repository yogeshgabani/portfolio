...
import dashonic from '../../Assets/dash.png'
import dash_1 from '../../Assets/dash-1.png'
import dash_2 from '../../Assets/dash-2.png'
import dash_3 from '../../Assets/dash-3.png'
import dash_4 from '../../Assets/dash-4.png'
import dash_5 from '../../Assets/dash-5.png'
import dash_6 from '../../Assets/dash-6.png'
import dash_7 from '../../Assets/dash-7.png'
import dash_8 from '../../Assets/dash-8.png'
...
export default function Dashonic() {
    ...
    return (
        <>
            <div className="portfoliomain bg-cover bg-no-repeat bg-center md:min-h-[350px] min-h-[200px] md:pt-[100px] pt-[50px] relative z-[1] after:absolute after:content-[''] after:top-0 after:z-[-1] after:left-0 after:w-full after:h-full after:bg-[#140c1cb3]" style={{ backgroundImage: `url(${background})` }}>
                <div>
                    <h1 className='sm:text-[50px] text-[30px] leading-[1.2] text-white text-center font-bold'>Dashonic</h1>
            ...
            <div className='bg-[#050709]'>
                <div className='container mx-auto md:px-10 px-3 md:py-[100px] py-[70px]'>
                    <div className='bg-[#2A1454] px-[60px] pt-[60px]'>
                        <div>
                            <img className='w-full h-full bg-cover bg-no-repeat' src={dashonic} alt="" />
                        </div>
                    </div>
                    <div className='grid md:grid-cols-2 grid-cols-1 pt-[50px] gap-5'>
                        <div className=''>
                            <h2 className='text-[45px] font-bold leading-[1.2] mb-3 text-white'>Dashonic</h2>
                            ...
                            <button className='hire-btn text-[15px] font-bold rounded-[50px] mt-8 px-[35px] py-[17px] transition-all duration-300 '><a className='flex items-center gap-2' href="https://admin-panel-ant-design-two.vercel.app/" target='_blank'>Live Preview<GoArrowUpRight className='text-[20px]' /></a></button>
                        </div>
                        <div className='grid sm:grid-cols-2 grid-cols-1 md:mt-0 mt-4 gap-3'>
                            ...
                            <div>
                                ...
                                <h5 className='text-[18px] font-medium leading-[1.2] text-white'>april 20, 2024</h5>
                            </div>
                            <div>
                    ...
                    <div className="slider-container my-10">
                        <Slider {...settings}>
                            <div className=''>
                                <div className='mx-3 '>
                                    <img className='w-full h-full' src={dash_1} alt="" />
                                </div>
                            </div>
                            <div>
                                <div className='mx-3'>
